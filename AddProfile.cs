...
namespace RECOMANAGESYS
{
    public partial class ResidencyRegisterfrm : Form
    {
        ...
        private bool ValidateRegistrationInputs(out int homeownerId)
        {
            ...
            string emergencyNum = emergencyNumtxt.Text?.Trim() ?? "";
            ...
            if (emergencyNum.Equals("Enter emergency number", StringComparison.OrdinalIgnoreCase)) emergencyNum = "";
            ...
            if (!Regex.IsMatch(emergencyNum, @"^\d{" + ContactNumberLength + "}$"))
            {
            ...
            {
                MessageBox.Show("Please enter a valid email address (e.g., example@gmail.com).", "Validation Error",
                    MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return false;
            }
            ...
            if (cmbUnitNum.SelectedItem == null)
            {
                ...
                {
                    MessageBox.Show("Please select a unit first.", "Validation Error",
                        MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return false;
                }
            }
