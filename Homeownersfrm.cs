        ...
        private void ShowResidentUnits(int residentId)
        {
            try
            {
                using (SqlConnection conn = DatabaseHelper.GetConnection())
                {
                    ...
                    if (dgv.Columns.Contains("UnitNumber"))
                        dgv.Columns["UnitNumber"].HeaderText = "Lot";

                    if (dgv.Columns.Contains("Residents (Tenants/Caretakers)"))
                        dgv.Columns["Residents (Tenants/Caretakers)"].HeaderText = "Tenant/Caretaker";
